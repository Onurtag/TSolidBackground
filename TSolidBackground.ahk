...
ShowNewMenu(nmX,nmY)
{
    ...
    if (nmX == "") {
        ...
        Gui, newmenu: Show, w640 h480 x%nmX% y%nmY%, TSolidBackground Advanced Features
    }
}
...
BackGui:
    ...
    Gui, cheat: Show, w640 h480 x%aX% y%aY%, TSolidBackground
    Gui, Destroy
    ShowNewMenu(aX,aY)
    Gui, cheat: Destroy
Return
...
ShowOptions()
{
    ...
    if (optX == "") {
        Gui, options: Show, w640 h480, TSolidBackground Advanced Options
    } else {
        Gui, options: Show, w640 h480 x%optX% y%optY%, TSolidBackground Advanced Options
    }
    Gui, newmenu: Destroy
    Return
}
...
ShowResizer()
{
    ...
    WinGetPos, optX, optY, optW, optH, TSolidBackground Advanced Features
    if (resX != "") {
        Gui, resizer: Show, w640 h480 x%resX% y%resY%, TSolidBackground Move/Resize Window
    } else if (optX != "") {
        Gui, resizer: Show, w640 h480 x%optX% y%optY%, TSolidBackground Move/Resize Window
    } else {
        Gui, resizer: Show, w640 h480, TSolidBackground Move/Resize Window
    }
    Gui, newmenu: Destroy
    Refresher()
    Return
...
ShowHooker()
{
    ...
    WinGetPos, optX, optY, optW, optH, TSolidBackground Advanced Features
    if (optX == "") {
        Gui, hook: Show, w640 h480, TSolidBackground Window Hooker (Alpha)
    } else {
        Gui, hook: Show, w640 h480 x%optX% y%optY%, TSolidBackground Window Hooker (Alpha)
    }
    Gui, newmenu: Destroy
    Return
}
...
StartDummyWindow:
    ...
    if (SavedDummy && DummyX != "ERROR") 
    {
        ...
        Gui, Dummy: Show, w640 h480, TSolidBackground Dummy Window
    }
    TBResized := WinExist("A")
Return
